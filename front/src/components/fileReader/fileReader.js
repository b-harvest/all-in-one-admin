...
class AddressFileReader extends React.Component {
  constructor(props) {
    ...
    this.state = {
      isFile: true,
      addressData: chainlinkAddressData,
  ...
  modifyAddressData() {
    ...
    return (
      <section className="Address-list">
        <div className="Address-list_oracle"><span>MY ORACLE ADDRESS  </span><br /><div className="my_oracle">{oracle}</div></div>
        <div className="Address-list_index" style={{ backgroundColor: '#ffc35245', fontWeight: 'bold', fontSize: "14px" }}>
  ...
  render() {
    return (
      <section className="File-upload">
        <div className="File-upload_infotext">{this.modifyAddressData()}</div>
